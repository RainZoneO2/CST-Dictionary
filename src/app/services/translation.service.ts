...
export class TranslationService {
  ...
  yandexKey:string = 'dict.1.1.20220508T235940Z.a2a39faf4b547bdf.1e582ae448779ba7a3d17410d18ebe9f5e104778'
  ...
  getLanguagePairs() : Observable<language[]> {
    return this.http.get(`${this.langApiUrl}`)
    .pipe( //Sends observables returned by the http.get() to error handler
  ...
  getLanguages() {
    var json = this.getLanguagePairs;
